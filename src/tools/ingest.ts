...
export async function ingestPackageHelper(s3path: string, repo: string | null | undefined, version: string): Promise<void> {
    ...
    uploadToS3(s3path, fs.createReadStream(dir));
